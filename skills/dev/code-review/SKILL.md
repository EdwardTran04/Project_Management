...
| **Checklist review** | Pre-landing, `/xd:ship` pipeline, security audit | `references/checklist-workflow.md` |
...
**Process:**
1. Invoke `/xd:scout` with edge-case-focused prompt
...
|------------|-----------|---------|
| `/xd:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/xd:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
