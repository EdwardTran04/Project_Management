...
c) Mô tả các bước trong quy trình: Bảng 4 cột: Bước | Tên bước | Mô tả | Đối tượng sử dụng. Phải mô tả đủ luồng dữ liệu chính và luồng rẽ nhánh.

*4.X.2. Yêu cầu chi tiết chức năng*

a) Mô hình phân rã chức năng: Vẽ cây phân rã chức năng. Mỗi chức năng phải được đánh mã (ví dụ: UC-01, F-01). Phân loại yêu cầu: Bắt buộc / Mong muốn / Lựa chọn / Tương lai.

b) Đặc tả từng chức năng — cấu trúc bắt buộc:
